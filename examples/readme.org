...
- [[file:example-lst-1.org][Listing 1: Simple introduction]]
- [[file:example-lst-2.org][Listing 2: Unreachable action]]
- [[file:example-lst-3.org][Listing 3: Semaphore]]
- [[file:example-lst-4.org][Listing 4: Multiple effects]]
